package com.couldr.squirrel.code.filter;
...
public class CorsFilter extends GenericFilterBean {
    ...
    private final static String ALLOW_HEADERS = StringUtils.joinWith(",", HttpHeaders.CONTENT_TYPE, API_ACCESS_KEY_HEADER_NAME);
