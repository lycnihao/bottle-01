...
import com.couldr.squirrel.code.exception.ForbiddenException;
import com.couldr.squirrel.code.exception.NotFoundException;
import com.couldr.squirrel.code.model.entity.User;
import com.couldr.squirrel.code.repository.UserRepository;
...
public class UserServiceImpl extends AbstractCrudService<User, Integer> implements UserService {
    ...
    public void mustNotExpire(User user) {
        ...
        if (user.getExpireTime() != null && user.getExpireTime().after(now)){
            ...
            throw new ForbiddenException("账号已被停用，请 " + SquirrelUtils.timeFormat(seconds) + " 后重试").setErrorData(seconds);
        }
    }
